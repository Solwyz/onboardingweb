...
function TimeSheetModal({ isOpen, onClose, onAdd, setRefreshKey, dataToEdit, setDataToEdit }) {
  const initialFormData = {
    date: dataToEdit ? dataToEdit.date : '',
    employeeName: '',
    project: '',
    task: dataToEdit ? dataToEdit.task : '',
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      {isAdding ?
        ...
        <div> {isUpdating ? <div className="bg-white p-8">
          <div className='px-4 flex gap-4'>
            <div>
              <ClipLoader
                color={'#465062'}
          ...
          <div className="bg-white w-[834px] p-8">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setFormData({ ...formData, date: formatDateToDDMMYYYY(selectedDate) }); // Store in DD-MM-YYYY format
                  }}
            ...
            <div className="flex justify-end gap-4">
              ...
              <button
                onClick={dataToEdit ? () => handleUpdate(dataToEdit.id) : handleSubmit}
