...
function ContactDetailsForm() {
  ...
  const handleInputChange = (e) => {
    ...
    // Update field and validate it
    setFormData((prev) => ({ ...prev, [name]: value }));
    validateField(name, value);

    // Enable the "Next" button if all required fields are filled and valid
    ...
    setIsNextButtonEnabled(allFieldsFilled && allValid);
  };
          ...
          <div className="flex justify-center">
            <ol className="flex items-center mt-[32px] w-[678px]">
              ...
              <li className="flex flex-col items-start  w-full text-center">
                ...
                <span className="mt-2 text-sm font-normal  text-[#2B2342] ml-[-5px]">
                  Basic
                </span>{" "}
              ...
              <li className="flex flex-col  items-start w-full text-center">
                ...
                <span className="mt-2 text-sm font-normal text-[#2B2342] ml-[-20px]">
                  Professional
                </span>{" "}
                {/* Text directly below the circle */}
              </li>
              ...
              <li className="flex flex-col items-start w-full text-center">
                ...
                <span className="mt-2 text-sm font-normal text-[#2B2342] ml-[-10px]">
                  Personal
                </span>{" "}
                {/* Text directly below the circle */}
              </li>
              ...
              <li className="flex flex-col items-start w-full text-center">
                ...
                <span className="mt-2 text-sm font-normal text-[#2B2342] ml-[-8px]">
                  Contact
                </span>{" "}
                {/* Text directly below the circle */}
              </li>
              ...
              <li className="flex flex-col items-start w-full text-center">
                <div className="flex w-full items-center after:content-[''] after:w-full after:h-1 after:border-b-[1px] after:border-[#C2C2C2] after:inline-block">
                  <span className="flex items-center justify-center w-5 h-5 bg-[#DCDCDC] rounded-full shrink-0"></span>
                </div>
                <span className="mt-2 text-sm font-normal text-[#696A70] ml-[-8px]">
                  Physical
                </span>{" "}
                {/* Text directly below the circle */}
              </li>
              ...
              <li className="flex flex-col items-start w-full text-center">
                ...
                <span className="mt-2 text-sm  font-normal text-[#696A70]">
                  Final
                </span>{" "}
                {/* Text directly below the circle */}
              </li>
  ...
  <textarea
    ...
    value={sameAsPrimary ? formData.primaryAddress : formData.secondaryAddress}
    onChange={handleInputChange}
  ...
  {errors.secondaryAddress && (
    <div className="text-red-500 text-xs mt-1">{errors.secondaryAddress}</div>
  )}
  ...
  <div className="flex mt-4">
    <div>
      ...
      <input
        ...
        maxLength="6"
        value={sameAsPrimary ? formData.primaryPincode : formData.secondaryPincode}
        onChange={handleInputChange}
        disabled={sameAsPrimary}
      ...
      {errors.secondaryPincode && (
        <div className="text-red-500 text-xs mt-1">{errors.secondaryPincode}</div>
      )}
    </div>
    ...
    <div className="ml-[16px]">
      ...
      <input
        type="text"
        name="secondaryCity"
        value={sameAsPrimary ? formData.primaryCity : formData.secondaryCity}
        onChange={handleInputChange}
        disabled={sameAsPrimary}
        onInput={(e) => (e.target.value = e.target.value.replace(/[^a-zA-Z\s]/g, ""))}
        className="px-3 py-2 border w-[247px] h-[48px] text-[#696A70] text-[14px] font-normal border-[#E6E6E7] focus:outline-[#A4A4E5] mt-[8px] rounded-lg"
      ...
      {errors.secondaryCity && (
        <div className="text-red-500 text-xs mt-1">{errors.secondaryCity}</div>
      )}
    </div>
  </div>
  ...
  <div className="mt-4">
    ...
    <input
      type="text"
      name="secondaryState"
      value={sameAsPrimary ? formData.primaryState : formData.secondaryState}
      onChange={handleInputChange}
      disabled={sameAsPrimary}
      onInput={(e) => (e.target.value = e.target.value.replace(/[^a-zA-Z\s]/g, ""))}
      className="px-3 py-2 border w-[178px] h-[48px] text-[#696A70] text-[14px] font-normal border-[#E6E6E7] focus:outline-[#A4A4E5] mt-[8px] rounded-lg"
    ...
    {errors.secondaryState && (
      <div className="text-red-500 text-xs mt-1">{errors.secondaryState}</div>
    )}
  </div>
</div>
</div>
            ...
            <div className="flex justify-end mt-[32px]">
              <button
                type="button"
                className={`bg-[#232E42]  text-white font-medium py-2 px-6 rounded-lg ${
