...
function ContactDetailsForm() {
    ...
    const validateFields = () => {
        ...
        if (!mobilePattern.test(formData.primaryMobile)) {
            newErrors.primaryMobile = 'Mobile number must be 10 digits.';
        }
        if (formData.secondaryMobile && !mobilePattern.test(formData.secondaryMobile)) {
            newErrors.secondaryMobile = 'Mobile number must be 10 digits.';
        }
        if (formData.emergencyContactNumber && !mobilePattern.test(formData.emergencyContactNumber)){
            newErrors.emergencyContactNumber='Mobile number must be 10 digits.'
        }

        // Validate pincodes
        if (!pincodePattern.test(formData.primaryPincode)) {
            newErrors.primaryPincode = 'Pincode must be 6 digits.';
        }
        if (formData.secondaryPincode && !pincodePattern.test(formData.secondaryPincode)) {
            newErrors.secondaryPincode = 'Pincode must be 6 digits.';
        }

        // Validate addresses and other fields
        for (const [key, value] of Object.entries(formData)) {
            if (!value.trim()) {
                newErrors[key] = '';
            } else if (key.includes('Name') || key.includes('City') || key.includes('State') || key.includes('Relationship')) {
                if (!namePattern.test(value)) {
                    newErrors[key] = 'This field must contain only letters.';
                }
            }
        }
                    ...
                    <div className='flex justify-center'>
                        <ol className="flex items-center mt-[32px] w-[678px]">
                            ...
                            <li className="flex flex-col items-start w-full text-center">
                                ...
                                <span className="mt-2 text-sm font-normal text-[#2B2342] ml-[-5px]">Salary</span> {/* Text directly below the circle */}
                            </li>
                            ...
                            <li className="flex flex-col items-start w-full text-center">
                                ...
                                <span className="mt-2 text-sm font-normal text-[#2B2342] ml-[-10px]">Personal</span> {/* Text directly below the circle */}
                            </li>
                            ...
                            <li className="flex flex-col items-start w-full text-center">
                                ...
                                <span className="mt-2 text-sm font-normal text-[#2B2342] ml-[-8px]">Contact</span> {/* Text directly below the circle */}
                            </li>
                            ...
                            <li className="flex flex-col items-start w-full text-center">
                                ...
                                <span className="mt-2 text-sm font-normal text-[#696A70] ml-[-8px]">Physical</span> {/* Text directly below the circle */}
                            </li>
                        ...
                        <div>
                            ...
                            <div className="flex mt-[16px]">
                                <div>
                                    ...
                                    />
                                    {errors.primaryMobile && <p className="text-red-500 text-xs">{errors.primaryMobile}</p>}
                                ...
                                <div className='ml-[16px]'>
                                    ...
                                    <input
                                        ...
                                        className="px-3 py-2 border w-[247px] h-[48px] text-[#696A70] text-[14px] font-normal border-[#E6E6E7] focus:outline-none mt-[8px] rounded-lg"
                                    />
                                    {errors.secondaryMobile && <p className="text-red-500 text-xs">{errors.secondaryMobile}</p>}
            ...
            <div className="flex">
                ...
                <div className='mt-4'>
                    ...
                    <div className="flex mt-4">
                        <div>
                            ...
                            />
                            {errors.primaryPincode && <p className="text-red-500 text-xs">{errors.primaryPincode}</p>}
                        </div>
                        <div className='ml-4'>
                            ...
                            <input
                                ...
                                className="px-3 py-2 border w-[247px] h-[48px] text-[#696A70] text-[14px] font-normal border-[#E6E6E7] focus:outline-none mt-[8px] rounded-lg"
                            />
                            {errors.primaryCity && <p className="text-red-500 text-xs">{errors.primaryCity}</p>}
                        </div>
                    </div>
                    <div className="mt-4">
                        ...
                        <input
                            ...
                            className="px-3 py-2 border w-[178px] h-[48px] text-[#696A70] text-[14px] font-normal border-[#E6E6E7] focus:outline-none mt-[8px] rounded-lg"
                        />
                        {errors.primaryState && <p className="text-red-500 text-xs">{errors.primaryState}</p>}
                    </div>
                </div>
                ...
                <div className='ml-[150px] mt-[16px]'>
                    ...
                    <textarea
                        ...
                        value={sameAsPrimary ? formData.secondaryAddress : formData.secondaryAddress}
                        onChange={handleInputChange}
                            ...
                            <div className="flex mt-[16px]">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="px-3 py-2 border w-[247px] h-[48px] text-[#696A70] text-[14px] font-normal border-[#E6E6E7] focus:outline-none mt-[8px] rounded-lg"
                                    />
                                    {errors.emergencyRelationship && <p className="text-red-500 text-xs">{errors.emergencyRelationship}</p>}
                                ...
                                <div className='ml-[16px]'>
                                    ...
                                    <input
                                        ...
                                        className="px-3 py-2 border w-[247px] h-[48px] text-[#696A70] text-[14px] font-normal border-[#E6E6E7] focus:outline-none mt-[8px] rounded-lg"
                                    />
                                    {errors.emergencyContactNumber && <p className="text-red-500 text-xs">{errors.emergencyContactNumber}</p>}
