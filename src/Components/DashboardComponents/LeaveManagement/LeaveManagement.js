...
function LeaveManagement() {
  ...
  return (
    <div className="flex">
      <div className="w-full mx-auto bg-red-900 p-8 rounded-lg shadow-lg">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-4">
                ...
                <select
                  ...
                  required
                  className="w-full p-3 rounded border border-gray-300 focus:ring focus:ring-blue-500"
                >
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  required
                  className="w-full h-32 p-3 rounded border border-gray-300 focus:ring focus:ring-blue-500"
